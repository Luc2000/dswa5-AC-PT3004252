...
var contatos = [
    { _id: 1, nome: 'Lucas Souza', email: 'lucas.annunziato@aluno.ifsp.edu.br' },
    { _id: 2, nome: 'Rafael', email: 'rafael@ifsp.edu.br' },
    { _id: 3, nome: 'Mertilo', email: 'mertilo.fagundes@ifsp.edu.br' }
]
